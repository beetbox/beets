...
string (for example, when using the field in a path component or showing the
field value on the screen) a separator has to be used. This option allows to
set which separator should be used. The default value is '; '.
