...
.. attention::
    ...
    You must not add a ``__init__.py`` file to the ``beetsplug`` directory.
    This ensures that Python treats your plugin as a namespace package. If you
    added ``__init__.py`` file, beets would be unable to find any other plugins
    in the ``beetsplug`` directory.
