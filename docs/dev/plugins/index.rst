...
.. Check out `this article`_ and `this Stack Overflow question`_ if you haven't
    heard about namespace packages.

.. Abstract base classes allow us to define a contract which any plugin must
...
.. There are a variety of packaging tools available for python, for example you
    can use poetry_, setuptools_ or hatchling_.
