...
The ``similarity`` plugin get similiarity information from last.fm and creates a graph-file `GEXF_File_Format`_ for further processing.

.. _GEXF_File_Format: https://gephi.org/gexf/format/
