...
- Add ``editor`` config option to allow users to permanently set their preferred
  ...
  :bug:`6641`
- Remove deprecated :doc:`plugins/acousticbrainz`, :doc:`plugins/absubmit`, and
  :doc:`plugins/beatport` plugin documentation. The AcousticBrainz service has
  been permanently shut down. :bug:`5780`
