...
- Store MBIDs for remixers, lyricists, composers, and arrangers in the new
  multi-valued fields ``remixers_mbid``, ``lyricists_mbid``, ``composers_mbid``,
  and ``arrangers_mbid``. :bug:`5698`
