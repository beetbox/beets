...
def get_newline_layout(
    ...
    left_split = split_into_lines(left.line, left_width_tuple)
    ...
    right_split = split_into_lines(right.line, right_width_tuple)
...
def get_layout_lines(
    ...
    separator = "" if right.line == "" else " -> "
    first_line_no_wrap = f"{indent_str}{left.line}{separator}{right.line}"
