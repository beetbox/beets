...
import textwrap
import warnings
from typing import TYPE_CHECKING, Any, Final, TextIO, TypeVar
...
class Subcommand:
    ...
    def __init__(
        ...
        func: (
            Callable[
                [library.Library, optparse.Values, list[str]],
                Any,
            ]
        )
        | None = None,
        ...
        """
        self.name: str = name
        self.func: Callable[[library.Library, optparse.Values, list[str]], Any]
        if func:
            self.func = func
