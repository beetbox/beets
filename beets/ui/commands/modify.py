...
def modify_items(lib: Library, query: list[str], *args, **kwargs) -> None:
...
def modify_albums(lib: Library, query: list[str], *args, **kwargs) -> None:
    """Modifies matching items according to user-specified assignments and
    deletions.
...
def print_and_modify(
    obj: LibModel, mods: dict[str, list[str]], dels: list[str]
) -> bool:
